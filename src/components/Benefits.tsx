      ...
      <div className="sm:text-lg text-black">
            ...
            >
              ...
              <li className="flex space-x-3">
                ...
                <p className="mb-8 font-light text-xl">
                  <span className="font-semibold text-application-color">Open and inclusive environment</span> - EBC promotes an inclusive club culture.  We accept guests and members of all skill levels. Our club is a prime location to play at your preferred level.
                </p>
              </li>
              <li className="flex space-x-3">
                <svg
