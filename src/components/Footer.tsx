...
const Footer = () => {
  ...
  return (
    <div>
        ...
        <div className="flex justify-between px-6 pt-6 w-full">
          ...
          <div className="flex justify-center mb-6 ">
            <a
              ...
              className="rounded-full border-2 border-white text-white leading-normal uppercase w-9 h-9 mr-5"
              aria-label="Facebook"
            >
              <svg
                aria-hidden="true"
            ...
            <a
              ...
              className="rounded-full border-2 border-white text-white leading-normal uppercase w-9 h-9"
      ...
      {openedModal && <Details setOpenedModal={setOpenedModal} from="footer" />}
    </div>
  );
};
