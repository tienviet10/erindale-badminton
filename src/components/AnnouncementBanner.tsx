        ...
        <div className="flex flex-row items-center justify-between">
          <div className="flex w-[70%] sm:w-[80%]">
            <span className="rounded-lg bg-yellow-500 p-2 border border-red-800">
              <svg className="h-4 w-4 text-red-900" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" aria-hidden="true">
            ...
            <p className="w-[90%] ml-3 truncate font-medium text-black my-auto text-semibold">
              No badminton Family day, Monday February 20th, 2023.
            </p>
          </div>
