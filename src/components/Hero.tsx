      ...
      <div className="bg-application-color text-white py-20">
        <div className="container mx-auto flex flex-col lg:flex-row items-center my-12 lg:my-24">
          <div className="flex flex-col w-full lg:w-1/3 justify-center items-start p-8">
            ...
            <p className="text-xl lg:text-base text-gray-50 mb-4 text-justify">Erindale Badminton Club is a 60-year strong non-profit badminton club for adults 18 years of age and older. The club aims to provide fair and equitable access to our facilities, regardless of each member's level of play.</p>
            <div className="mt-4 z-10">
              ...
              <a href="#Pricing"
                className="bg-transparent hover:bg-text-application-color text-text-application-color hover:text-black rounded shadow hover:shadow-lg py-2 px-6 border border-text-application-color hover:border-transparent ml-4">
                Pricing
              </a>
            </div>
