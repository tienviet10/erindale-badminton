              ...
              <div className="p-6">
                <ol className="list-inside">
                  ...
                  <li className="mb-4 flex items-center">
                    ...
                    </svg>Able to join 2 social event nights, in house tournament, and year end party 
                  </li>
                </ol>
              </div>
            </div>
              ...
              <div className="p-6">
                <ol className="list-inside">
                  ...
                  <li className="mb-4 flex items-center">
                    ...
                    </svg>Able to join 4 social event nights, in house tournament, and year end party 
                  </li>
                </ol>
              </div>
            </div>
